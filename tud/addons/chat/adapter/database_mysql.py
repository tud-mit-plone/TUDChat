...
class DatabaseMySQL():
    ...
    def __init__(self, chat):
        ...
        sql_connector_id = hasattr(chat, "connector_id") and chat.connector_id or chat._connector_id
        prefix = hasattr(chat, "database_prefix") and chat.database_prefix or chat._database_prefix
